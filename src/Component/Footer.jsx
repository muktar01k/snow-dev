...
export const Futter = () => {
    ...
    return (
        <div className="bg-[#211e39] xr:h-[40rem] xr:w-[414px] xr:mt-[2rem] pro:w-[428px] x:w-[375px] x:h-[30rem] x:mt-[2rem] smm:w-[390px]">
            <div className="xr:pt-[2rem] x:pt-[2rem]">
                {/* <div className="">  */}
                <div className="w-[10rem] xr:ml-[8rem] x:ml-[6rem]">
                    <img src={Logo} alt="" />
                </div>
                <div className="xr:grid xr:grid-cols-3 xr:text-center xr:ml-[0.5rem] xr:gap-[1rem] xr:mt-[2rem] x:grid x:grid-cols-3 x:text-center x:mt-[2rem]">  
